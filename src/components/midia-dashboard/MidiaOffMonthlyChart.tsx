...
interface MidiaOffMonthlyChartProps {
  data: Array<{
    month: string;
    orcado: number;
    realizado: number;
...
export const MidiaOffMonthlyChart = ({ data }: MidiaOffMonthlyChartProps) => {
  return (
    <Card>
      <CardHeader>
        <CardTitle className="text-lg">Distribuição Mensal - Mídia Off</CardTitle>
      </CardHeader>
      <CardContent>
        {data.length === 0 ? (
