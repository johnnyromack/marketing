...
Deno.serve(async (req) => {
  ...
  try {
    ...
    const payload: TikTokCampaignData = await req.json();
    console.log("Received TikTok Ads payload:", JSON.stringify(payload));
    ...
    console.log(`TikTok webhook processed ${recordsProcessed} campaigns`);
